...
<head>
    ...
    <?= $this->Html->meta('icon') ?>
    <title>YogaBuddy - Admin Dashboard</title>
...
<div id="wrapper">
    ...
    <ul class="navbar-nav sidebar accordion" id="accordionSidebar" style="background-color: #94EDED">
        ...
        <!-- Sidebar - Brand -->
        <a class="sidebar-brand d-flex align-items-center justify-content-center" style="color: rgba(224, 117, 245, 0.97);" href="<?= $this->Url->build(['controller' => 'Admins', 'action' => 'adminDashboard']) ?>">
        ...
        <li class="nav-item">
            <a class="nav-link"
               href="<?= $this->Url->build(['controller' => 'Admins', 'action' => 'adminDashboard']) ?>"
            >
        ...
        <li class="nav-item">
            <a class="nav-link"
               href="<?= $this->Url->build(['controller' => 'Admins', 'action' => 'index']) ?>"
            >
                <i class="fas fa-solid fa-right-from-bracket" style="position: relative; left: 5px; width: 15px; height: 15px"></i>
                <b>User Management</b>
            </a>
        ...
        <li class="nav-item">
            <a class="nav-link"
               href="<?= $this->Url->build(['controller' => 'Admins', 'action' => 'adminViewCourses']) ?>"
            >
                <i class="fas fa-solid fa-right-from-bracket" style="position: relative; left: 5px; width: 15px; height: 15px"></i>
        ...
        <li class="nav-item">
            <a class="nav-link"
               href="<?= $this->Url->build(['controller' => 'Students', 'action' => 'myCourses']) ?>"
            >
                <i class="fas fa-solid fa-right-from-bracket" style="position: relative; left: 5px; width: 15px; height: 15px"></i>
