...
<div class="row">
    ...
    <div class="column-responsive column-80">
        <div class="sections form content">
            <?= $this->Form->create($section, ['type' => 'file']) ?>
            <fieldset>
                ...
                echo $this->Form->label('video', 'Current Video');
                echo $this->Html->link($section->video, '/videos/' . $section->video, ['target' => '_blank']);
                echo $this->Form->control('new_video', ['type' => 'file', 'label' => 'New Video', 'required' => false]);
                ?>
