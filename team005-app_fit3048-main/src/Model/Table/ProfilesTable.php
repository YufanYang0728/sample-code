...
class ProfilesTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ->boolean('tobacco_smoked')
            ->requirePresence('tobacco_smoked', 'create')
            ->notEmptyString('tobacco_smoked');
        ...
        $validator
            ...
            ->requirePresence('annual_income', 'create')
            ->notEmptyString('annual_income');

        $validator
            ->decimal('home_loan')
            ->requirePresence('home_loan', 'create')
            ->notEmptyString('home_loan');
