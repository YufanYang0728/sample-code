...
<!--            <div class="progress-indicator-text" style="font-size: 18px; margin-left: 20px;">Answered <span id="current-question-index">1</span> out of --><?php //= count($questions) ?><!-- questions</div>-->
        ...
        <?php echo $this->Form->create(null, ['url' => ['controller' => 'Questions', 'action' => 'selectDesignatedPremadeQuestionnaire'], 'id' => 'questionnaire-form']); ?>
        ...
        <div class="btn-group">
            <a href="<?= $this->Url->build(['action' => 'packageSelection', $userId]); ?>"  class="btn btn-primary btn-round btn-3d"style="background-color: #0D8ABF;">Go Back to Package Selection</a>
