...
<!--                    <th>--><?php //= $this->Paginator->sort('user_id') ?><!--</th>-->
                    ...
                    <th><?= $this->Paginator->sort('audience_type') ?></th>
            ...
            <?php foreach ($questions as $question): ?>
                <tr>
<!--                    <td>--><?php //= h($question->id) ?><!--</td>-->
<!--                    <td>--><?php //= $question->has('user') ? $this->Html->link($question->user->id, ['controller' => 'Users', 'action' => 'view', $question->user->id]) : '' ?><!--</td>-->
                    <td><?= h($question->created) ?></td>
                    <td><?= h($question->modified) ?></td>
                    <td><?= h($question->stage) ?></td>
                    <td><?= h($question->audience_type) ?></td>
                    <td><?= h($this->Text->truncate($question->prompt, 30)) ?></td>
