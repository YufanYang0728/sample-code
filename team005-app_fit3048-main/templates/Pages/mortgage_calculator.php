...
<div class="row">
        ...
        <form id="mortgage2_form">
            ...
            <div class="input-group-prepend">
                ...
                <input id="Year_Term23" style="width: 200px" name="Year_Term2" type="number" class="form-control" min="1" max="100" required="required">
            </div>
            ...
            <div class="input-group mb-4">
                <div class="input-group">
                    ...
                    <input id="Monthly_Amount23" name="Loan_Amount" style="width: 200px"  type="number" class="form-control" min="1" max="999999999" required="required">
                ...
                <div class="input-group mb-4">
                    <div class="input-group">
                        ...
                        <input id="Interest_Rate23" style="width: 200px" name="Interest_Rate2" onKeyPress="return check(event,value)"  name="Interest_Rate2" type="number" min="0" max="100" class="form-control" required="required">
                    </div>
                </div>
        ...
        <form id="mortgage3_form">
            ...
            <div class="input-group mb-4">
                <div class="input-group">
                    ...
                    <input id="Mortgage_Amount3" name="Mortgage_Amount3" style="width: 200px"  type="number" class="form-control" min="1" max="999999999" required="required">
                    </div>
            </div>
    
            
            <span style="float: left">What is the <span class="blue" > Fee($)</span> per payment?</span>
            <div class="input-group mb-4">
            <div class="input-group-prepend">
                        <div class="input-group-text">$</div>
                    </div>
                <input id="Fee" style="width: 200px" name="Fee" type="number" class="form-control" min="0" max="9999999999" required="required">
            </div>
                ...
                <span style="float: left">What is the current<span class="blue" > annual Interest Rate?</span> </span>
                <div class="input-group mb-4">
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <div class="input-group-text">%</div>
                        ...
                        <input id="Interest_Rate3" style="width: 200px" name="Interest_Rate3" onKeyPress="return check(event,value)"  name="Interest_Rate3" type="number" min="0" max="100" class="form-control" required="required">
                    </div>
                </div>

               
                <span style="float: left">What is the amount of  <span class="blue" > monthly payment?</span></span>
                 <div class="input-group mb-4">
                    <div class="input-group-prepend">
                        <div class="input-group-text">$</div>
                    </div>
                <input id="Monthly_Repayment" style="width: 200px" name="Monthly_Repayment" type="number" class="form-control" min="1" max="999999999999" required="required">
                </div>

                <span style="float: left"> What is your  <span class="blue" > repayment frequency</span> per year?</span>
                 <div class="input-group mb-4">
                   
                <input id="Monthly_Repayment_Frequency" style="width: 200px" name="Monthly_Repayment_Frequency" type="number" class="form-control" min="1" max="12" required="required">
                </div>

                <span style="float: left">What is your  <span class="blue" > fee payment frequency</span> per year?</span>
                 <div class="input-group mb-4">
                    
                <input id="Fee_Repayment_Frequency" style="width: 200px" name="Fee_Repayment_Frequency" type="number" class="form-control" min="1" max="12" required="required">
                </div>
...
<br>
        <div class="form-group">
            <button id="Submit_Fee" class="btn btn-primary" style=" font-size: 2vh; border-radius: 12px; text-transform: uppercase">Calculate</button>
        </div>
                <br>
            </div>
            ...
            <div class="col-5 thinBox-carLease" style="margin-left: 5%;">
                ...
                <tr >
                    ...
                    <tr >
                        <td style="text-align: left"> <h7> Fee per payment: </h7> </td>
                        <td style="text-align: right; padding-left: 5vw"> <h7  class="number" id="Fee_Amount">0</h7>
                        </td>
                    </tr>
                   
                    <tr >
                        <td style="text-align: left"> <h7> Montly Payment Amount($): </h7> </td>
                        <td style="text-align: right; padding-left: 5vw"> <h7  class="number" id="Monthly_Payment_Amount3">0</h7>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="text-align: left" > <h2 style="font-family: Helvetica" >Paid Off By: </h2> </td>
                        <td style="text-align: right"> <h2  class="number" id="Monthly_Payment1" >N/A</h2></td>
                    </tr>
