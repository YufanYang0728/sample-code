...
// Connect to database
$con = mysqli_connect("localhost", "superuser", "superuser", "advise_dev");
    ...
    <div class="container">
        <main class="py-5 text-center">
            <div class="py-5 text-center">
                <h2 class="section-heading text-uppercase">Investment Advice</h2>
                <p class="section-subheading text-muted">Let's help you invest your money in a smarter way!</p>
            </div>
                        ...
                        <div class="form-group fieldGroup">
                            ...
                            <form action="test1" method="get" class="pb-2">
                                ...
                                <div class="row" id="investment">
                                    <div class="col-3">
                                        <select class="form-select" aria-label="Default select example" id="CompanyName" name="CompanyName" required>
                                    ...
                                    <div class="col-5" id="product">
                                        <select class="form-select" aria-label="Default select example" id="percentage" name="percentage" required>
                                            <?php
        ...
        <div class="row d-flex justify-content-center">
            <div class="col-4">
                <div class="card border-info mb-3">
                    <?php echo $this->Html->image('vanguard-logo.png', ['alt' => 'Vanguard logo', 'class' => 'img-fluid m-2']); ?>
                    ...
                    <div class="card-header bg-light d-flex p-2 bd-highlight">
                        <h6 class="text-muted mb-0">Investment amount:</h6>
                    </div>
                    <div class="card-body text-white bg-primary d-flex p-2 bd-highlight ">
                        <p class="mb-0" id=currAmount-output></p>
                    </div>
                    <div class="card-header bg-light d-flex p-2 bd-highlight">
                        <h6 class="text-muted mb-0">Your annual investment fees will be:</h6>
                    </div>
                    <div class="card-body text-white bg-primary d-flex p-2 bd-highlight">
                        <p class="mb-0" id=newAmount-output></p>
                    </div>
                    <div class="card-header bg-light d-flex p-2 bd-highlight">
                        <h6 class="text-muted mb-0">You will be saving:</h6>
                    </div>
                    <div class="card-body text-white bg-primary d-flex p-2 bd-highlight">
